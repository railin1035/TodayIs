...
public class memo_edit extends AppCompatActivity implements View.OnClickListener{
        ...
        /*select 컬러피커*/
        @BindView(R.id.edit_text_primarycolor) Button text_color_btn; // 텍스트 기본 색상
        @BindView(R.id.edit_background_primarycolor) Button background_color_btn; // 배경 기본 색상
        @BindView(R.id.edit_background_border_primarycolor) Button background_border_color_btn; // 테두리 기본 색상
        ...
        /*//select 컬러피커*/
        @BindView(R.id.edit_text_size) Button text_size_btn; // 폰트 사이즈 버튼
        @BindView(R.id.edit_text_left) ImageView text_left_view; // 왼쪽 정렬 버튼
        @BindView(R.id.edit_text_center) ImageView text_center_view; // 중앙 정렬 버튼
        @BindView(R.id.edit_text_right) ImageView text_right_view; // 오른쪽 정렬 버튼
        @BindView(R.id.edit_text_colorpicker) ImageView text_colorpicker; // 텍스트 색상
        @BindView(R.id.edit_background_colorpicker) ImageView background_colorpicker; // 배경 색상
        @BindView(R.id.edit_background_border_colorpicker) ImageView border_colorpicker; // 테두리 색상
...
protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_Content = findViewById(R.id.memo_edit_contents);
        edit_Date = findViewById(R.id.memo_edit_day);
        /*//데이터베이스*/
        ...
        titlememo.setOnFocusChangeListener(new View.OnFocusChangeListener() {
                @Override
                public void onFocusChange(View v, boolean hasFocus) { HideBox(); }
        });
        ...
        text_select_colorpicker.setClickListener(new ClickListener() {
                @Override
                public void onClick(int color) { text_color_btn.setBackgroundColor(color); }
        });
        findViewById(R.id.edit_text_primarycolor).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) { text_select_colorpicker.show(); }
        });
        ...
        background_select_colorpicker.setClickListener(new ClickListener() {
                @Override
                public void onClick(int color) { background_color_btn.setBackgroundColor(color); }
        });
        findViewById(R.id.edit_background_primarycolor).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) { background_select_colorpicker.show(); }
        });
        ...
        background_border_select_colorpicker.setClickListener(new ClickListener() {
                @Override
                public void onClick(int color) { background_border_color_btn.setBackgroundColor(color); }
        });
        findViewById(R.id.edit_background_border_primarycolor).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) { background_border_select_colorpicker.show(); }
        });
        /*//select 컬러피커*/
        /*폰트 크기 설정*/
        ...
        if (savedInstanceState != null) { color = savedInstanceState.getInt(SAVED_STATE_KEY_COLOR, INITIAL_COLOR); }
...
//class end
        ...
        private void showAlertDialog(){
                ...
                String font_num;
                for(int i=1; i<=50; i++){
                        if(i<10){ font_num = String.valueOf(" "+i); }
                        else { font_num = String.valueOf(i); }
                        Data.add(font_num); } // 다이얼로그 데이터 리스트
                ...
                window.setAttributes(lp); } // 다이얼로그 크기 설정
    @Override
