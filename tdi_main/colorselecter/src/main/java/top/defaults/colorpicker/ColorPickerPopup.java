...
public class ColorPickerPopup {
    ...
    public void show(View parent, final ColorPickerObserver observer) {
        ...
        TextView on = layout.findViewById(R.id.on);
        on.setText(onTitle);
        ...
        colorHex.setVisibility(View.GONE);
    ...
    public static class Builder {
        ...
        public Builder onTitle(String title) {
            onTitle = title;
            return this;
        }
